...
namespace NWUClustering
{
  ...
  void ClusteringAlgo::writeClusters_uf(ostream& o)
  {
    ...
    for(i = 0; i < m_pts->m_i_num_points; i++)
    {
      ...
      root = m_parents[i];
      if(i == 9925){
        cout << "Write clusters: parent of 9925: " << m_parents[i] << endl;
      }
      ...
      for(int i = 0; i < growing_points.size(); i++)  // Iterates through every growing point
      {
        ...
        for (j = 0; j < ne.size(); j++)
        {
          ...
          /*if(root1 == 9925){
            ...
            cout << "Parent of root2: " << dbs.m_parents[root2] << endl;
            cout << "Parent of root1: " << dbs.m_parents[root1] << endl;
          }*/
          ...
          { 
            ...
            if(dbs.m_member[npid] == 0)
            {
              ...
              if(find(growing_points.begin(), growing_points.end(), npid) == growing_points.end())
              {
                ...
                //Here is the new change SNG2, set difference operation
